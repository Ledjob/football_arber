...
def update_league_json(games, league_info, json_file):
    ...
    for game in games:
        ...
        for league_game in league_data:
            if (similar(league_game['home_team'], team1) > 0.5 and similar(league_game['away_team'], team2) > 0.7) or \
               (similar(league_game['home_team'], team2) > 0.5 and similar(league_game['away_team'], team1) > 0.7):
